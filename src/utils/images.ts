...
const PRODUCT_SLUG_IMAGES: Record<string, string> = {
  ...
  // Bedroom Collection (6 items)
  "queen-size-bedroom-suite": "https://images.unsplash.com/photo-1505691938895-1758d7feb511?auto=format&fit=crop&w=1000&q=80",
  "king-size-bed-frame": "https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&w=1000&q=80",
  "single-bed-with-storage": "https://images.unsplash.com/photo-1560185127-6a2806647f81?auto=format&fit=crop&w=1000&q=80",
  "4-door-wardrobe": "https://images.unsplash.com/photo-1595428774223-ef52624120d2?auto=format&fit=crop&w=1000&q=80",
  "bedside-table-set": "https://images.unsplash.com/photo-1532372320572-cda25653a26d?auto=format&fit=crop&w=1000&q=80",
  "dressing-table-with-mirror": "https://images.unsplash.com/photo-1615876234886-fd9a39faa97f?auto=format&fit=crop&w=1000&q=80",

  // Dining Collection (6 items)
  "6-seater-dining-table-set": "https://images.unsplash.com/photo-1615066390971-03e4e1c36ddf?auto=format&fit=crop&w=1000&q=80",
  "4-seater-glass-dining-set": "https://images.unsplash.com/photo-1577140917170-285929fb55b7?auto=format&fit=crop&w=1000&q=80",
  "8-seater-dining-table": "https://images.unsplash.com/photo-1530018607912-eff2df11a11b?auto=format&fit=crop&w=1000&q=80",
  "bar-stools-set-of-4": "https://images.unsplash.com/photo-1503602642458-232111445657?auto=format&fit=crop&w=1000&q=80",
  "dining-buffet-sideboard": "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1000&q=80",
  "foldable-dining-table": "https://images.unsplash.com/photo-1532372576044-6c0150d9c1a3?auto=format&fit=crop&w=1000&q=80",

  // Office Space (6 items)
  "executive-office-desk": "https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=1000&q=80",
  "high-back-office-chair": "https://images.unsplash.com/photo-1580481072645-022f9a6dbf27?auto=format&fit=crop&w=1000&q=80",
  "office-bookshelf-unit": "https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?auto=format&fit=crop&w=1000&q=80",
  "2-person-office-workstation": "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=1000&q=80",
  "filing-cabinet-3-drawer": "https://images.unsplash.com/photo-1595514534839-8f8e52aed26c?auto=format&fit=crop&w=1000&q=80",
  "reception-desk": "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=1000&q=80",

  // Accent & Living room items (6 items)
  "decorative-coffee-table": "https://images.unsplash.com/photo-1533090161767-e6ffed986c88?auto=format&fit=crop&w=1000&q=80",
  "tv-stand-unit": "https://images.unsplash.com/photo-1593508512255-86ab42a8e620?auto=format&fit=crop&w=1000&q=80",
  "rattan-accent-chair": "https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?auto=format&fit=crop&w=1000&q=80",
  "bookshelf-display-unit": "https://images.unsplash.com/photo-1544644181-1484b3fdfc62?auto=format&fit=crop&w=1000&q=80",
  "floor-mirror": "https://images.unsplash.com/photo-1617103996702-96ff29b1c467?auto=format&fit=crop&w=1000&q=80",
  "console-table": "https://images.unsplash.com/photo-1565538810844-1e119fea2ec5?auto=format&fit=crop&w=1000&q=80",

  // Full Packages (4 items)
  "complete-living-room-package": "https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=1000&q=80",
  "complete-bedroom-package": "https://images.unsplash.com/photo-1560185007-c5ca9d2c014d?auto=format&fit=crop&w=1000&q=80",
  "new-home-setup-package": "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=1000&q=80",
  "office-starter-package": "https://images.unsplash.com/photo-1502444330042-d1a1ddf9bb5c?auto=format&fit=crop&w=1000&q=80"
};
